...
If you use a 64-bit OS, please download the source code tarball. Follow the instruction here to complie it. https://hadoop.apache.org/docs/r2.6.0/hadoop-project-dist/hadoop-common/NativeLibraries.html
